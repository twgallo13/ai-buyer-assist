...
const Analyze: React.FC = () => {
        ...
        try {
            if (mode === 'quick') {
                ...
                const mockResult: AnalysisResult = {
                    ...
                    freshness: 90,
                    styleFit: 70,
                    summary: "Based on market analysis, this appears to be a trending category with moderate competition.",
    ...
    }, [input, mode, selectedIntent, selectedHorizon]);
        ...
        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
            <div>
                ...
                <textarea
                    ...
                    placeholder="e.g., 'sustainable fashion trends for women', 'competitive landscape for athletic wear', 'market opportunity for eco-friendly packaging'"
                    rows={4}
                    style={{
                        width: '100%',
                        padding: '1rem',
            ...
            <button
                ...
                style={{
                    padding: '1rem 2rem',
                    backgroundColor: isLoading || !input.trim() ? 'var(--muted)' : 'var(--accent)',
                    color: 'white',
                    border: 'none',
                    borderRadius: '8px',
